...
class BarcodeScanResult {
  ...
  /// Validation + inference + lookup metadata
  ...
  double get confidence {
    final meta = metadata;
    if (meta != null && meta['confidence'] is num) {
      return (meta['confidence'] as num).toDouble().clamp(0.0, 1.0);
    }
  ...
  String? get gs1Region =>
      metadata != null ? metadata!['gs1_region'] as String? : null;

  /// Confidence of GS1 inference (0–1)
  double? get gs1Confidence {
    final val = metadata?['gs1_confidence'];
    return val is num ? val.toDouble().clamp(0.0, 1.0) : null;
  }
